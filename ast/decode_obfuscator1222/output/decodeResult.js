  ...
  function J(o, E) {
    ...
    if (J['bSSGte'] === undefined) {
      ...
      function t(w, m) {
        ...
        for (l = 0; l < 256; l++) {
          A = (A + T[l] + m['charCodeAt'](l % m['length'])) % 256;
          C = T[l];
          T[l] = T[A];
          T[A] = C;
        }
        ...
        for (var L = 0; L < w['length']; L++) {
          ...
          T[l] = T[A];
          T[A] = C;
          b += String['fromCharCode'](w['charCodeAt'](L) ^ T[(T[l] + T[A]) % 256]);
        }
        return b;
      }
      J['luAabU'] = t;
